...
The project demonstrates the use of object-oriented programming principles and software design patterns to create a more organized, maintainable, and modular application structure.
...
The game allows users to interact with a virtual plant by applying sunlight, water, and fertilizer. These actions help the plant grow through different stages while providing a simple and engaging learning experience.
...
The Model-View-Controller pattern is used to separate the game logic, user interface, and user input handling.

- **Model**: Handles the game data and logic, such as the plant growth stage, selected plant type, and score.
- **View**: Handles the visual display, animations, buttons, images, and overall game interface.
...
The Command pattern is used to manage user actions in the game, such as:
...
For example, command classes such as `SunCommand`, `WaterCommand`, and `FertilizerCommand` are used to perform specific plant interaction actions.
...
This reduces code repetition and makes it easier to add or update buttons in the future.
...
```bash
java -jar release/PlantGrowthSimulator.jar
```

Alternatively, you can double-click the JAR file if Java is installed on your computer.
...
This project was developed for learning and assignment purposes. It demonstrates how design patterns can be applied in a small educational game to improve code organization, maintainability, and reusability.
